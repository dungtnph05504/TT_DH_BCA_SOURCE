package com.nec.asia.nic.comp.a08database.dao;
...
public interface GetRecordDetailDao {
	...
	public List<DocumentCancelDetail> getDocumentCancelDetail(String fullname,
			...
			String gender, String passportNo, String identityCardNo)throws Exception;
