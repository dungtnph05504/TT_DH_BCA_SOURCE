...
DefaultBusinessServiceImpl<Codes, String, CodesDao> implements CodesService {
	...
	public List<String> getAllCodeDescs() throws Exception {
		try {
			return this.codesDao.getAllCodeDescs();
		} catch (Exception e) {
			throw e;
		}
	}
	...
	public PaginatedResult<Codes> getCodesByCodeId(String codeId, int pageNo,
		...
		try {
			pagRs = this.codesDao.getCodesByCodeId(codeId, pageNo, pageSize);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return pagRs;
	...
	public PaginatedResult<CodeValues> getCodevalueByCoditions(String codeId,
		...
		PaginatedResult<CodeValues> pagRs = null;
		try {
			pagRs = this.codeValuesDao.getCodevalueByCoditions(codeId, codeValue, codeValueDesc, pageNo, pageSize);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return pagRs;
