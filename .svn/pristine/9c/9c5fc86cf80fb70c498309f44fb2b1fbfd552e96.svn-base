...
<c:url var="backBtnUrl" value="/servlet/investigationConfirm/investigationConfirmList" />
...
<style>
   ...
   <div class="new-heading-2">CHI TIẾT HỒ SƠ PHÊ DUYỆT SƠ BỘ</div>
    ...
    <div class="data_table2" style="margin:30px 0px; color: #337ab7;">
       ...
       <div class="form-group text" style="display: block;">
            ...
            <button type="button" class="btn btn-primary" onclick="requestPassportYear(); return false;" name="passportYearBtn" id="passportYearBtn">
				<span class="glyphicon glyphicon-edit"></span> Thay đổi
			</button>
			<input type="text" value="${periodValid}" id="passportYeartxt" name="passportYeartxt" style="display:none;margin-bottom: 10px;" /> &nbsp;
			...
			<input type="button" class="btn btn-sm btn-danger"  onclick="doPassportYearCancel()" name="ppYearCancel" id="ppYearCancel"  value="Hủy" style="display:none;float: right;margin-right: 320px;" />
        </div>
    ...
    <div id="dialog-approve"></div>
		...
		<div class="waitingWhenDoneWaiting" style="display:block; position: fixed; bottom:5px; right:10px; border-radius: 5px; border: 1px solid gray; background-color: rgb(255, 255, 255); z-index: +1000">
			<div style="margin: 10px"> 
				...
				<button type="button" class="btn btn-danger"  onclick="openBoxReject();" name="reject">
		 ...
		 ///2. Sửa năm hộ chiếu
		   function requestPassportYear() { 
			  ...
			  // document.getElementById("passportYearDisplay").style.display = 'none';
			   ...
			   document.getElementById("ppYearOk").style.display = 'inline';
