...
public class InfoDocToPrintMemo {
	...
	//Hoald 09.09.2020 thông tin thêm
	private String sendDiplomaDate;
	...
	public String getSendDiplomaDate() {
		return sendDiplomaDate;
	}
	public void setSendDiplomaDate(String sendDiplomaDate) {
	...
	public String getSendAbout() {
		return sendAbout;
	}
	public void setSendAbout(String sendAbout) {
		this.sendAbout = sendAbout;
	}
