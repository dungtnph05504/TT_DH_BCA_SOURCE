...
<%@ taglib uri="http://displaytag.sf.net" prefix="display" %>  
   ...
   <div class="roundedBorder ov_hidden">
			     ...
			     <div style="border:  solid 1px gray; border-radius:4px; margin: 2px; display:none">
							...
							<div> 
								...
								<div style="vertical-align: text-top; display: inline-block; width:  20%; margin-right:29%; float: left"> 
									<div style="border:  solid 1px gray; border-radius:4px; margin: 2px;min-height:74px;"> 
										<div style="margin:2px">  
											<div style="text-align:  center">
												<input type="button" class="btn_small btn-primary"  value="Bỏ việc giao đã chọn" style="" onclick="doUnassign();"  />
											</div>     
										</div>
									</div>
								</div> 
						...
						<div> 
							<div style="vertical-align: text-top; display: inline-block; width:  30%; margin-left:35%; margin-right:34%; float: left"> 
								<div style="border:  solid 1px gray; border-radius:4px; margin: 2px">  
									<div style="margin:2px">
										<div style="text-align:  center">
											<input type="button" class="btn_small btn-primary"  value="Bỏ tất cả việc đã giao" style="" onclick="doUnassignAllForUser();"  />
										</div>
										<div style="text-align:  center">
											Hiện được giao cho tên người dùng
										</div>  
										<div style="text-align:  center">
	...
	<%  /* ******************************************************************************************************************** */ %>	
		...
		<c:url var="urlUnassign" value="/servlet/investigationAssignment/unassign" />  
	...
	<%  /* ******************************************************************************************************************** */ %>	
		...
		<c:url var="urlUnassignAllForUser" value="/servlet/investigationAssignment/unassignAllForUser" />  
