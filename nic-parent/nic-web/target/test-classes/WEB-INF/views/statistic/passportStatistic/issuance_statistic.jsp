...
<div class="content-item-title">
            <div class="oplog-title__txt">Thống kê việc cấp phát hộ chiếu</div>
        </div>
			...
			<div class="col-sm-12">
				<fieldset class="scheduler-border">
					...
					<div class="form-group" style="margin-top: 10px;">
						<div class="col-sm-3">
							<label class="col-sm-5 control-label" style="margin-top: 4px; padding: 0px; text-align: center;">Trạng thái duyệt cấp HC:</label>
							<div class="col-sm-7">
								<form:select id="approveStage" path="approveStage" class="style-width-100">
									<form:option value="">-- Tất cả --</form:option>
									<form:option value="APPROVE_D">Đã duyệt cấp</form:option>
									<form:option value="APPROVE_C">Bổ sung hồ sơ</form:option>
									<form:option value="APPROVE_K">Từ chối cấp</form:option>
								</form:select>
							</div>
						</div>
						<div class="col-sm-3">
						...
						<div class="col-sm-3">
							<label class="col-sm-5 control-label" style="margin-top: 4px; padding: 0px; text-align: center;">Cơ quan đăng ký:</label>
							<div class="col-sm-7">
								...
								<table id="dtBasicExample" class="table table-bordered table-sm table-hover" cellspacing="0" width="100%">
								  <thead>
								    <tr>
								      ...
								      <c:if test="${empty approveStage}">
								      	<th class="th-sm" style="width : 100px;">Trạng thái duyệt cấp HC
								      </c:if>
								      </th>
									    ...
									    <c:forEach items="${listTransaction}" var="item">
										    <tr>										      
										     	<td align="center">${item.stt}</td>
										      	...
										      	<c:if test="${empty approveStage}">
										      		<td align="left">${item.approveStage}</td>
										      	</c:if>
										      	<c:if test="${empty regSiteCode}">
