...
<c:url var="getCaTheHoaUrl" value="/servlet/central/bieuDoCaTheHoa" />
...
<div class="form-desing">
   <div> 
	   <div>
		   <div class="row">
		   	   <div class="ov_hidden">
			   <div class="new-heading-2">CÁ THỂ HÓA</div>
       				<div id="bieuDoCaTheHoa"></div>
			   </div>
		   </div>
		   <div class="row">
...
<script type="text/javascript">
	...
	var chart = new Highcharts.chart('bieuDoCaTheHoa', {
	    title: {
	        text: ''
	    },
	    xAxis: {
