...
<c:url var="url" value="/servlet/central/reportRegProcess" />
<c:url var="urlPrint" value="/servlet/central/printReportRegProcess" />
<style>
...
<div class="content-item-title">
            <div class="oplog-title__txt">Báo cáo tiến trình đăng ký</div>
        </div>
			...
			<div class="col-sm-12">
				<fieldset class="scheduler-border">
					...
					<div class="form-group" style="margin-top: 10px;">
						...
						<div class="col-sm-3">
							<label class="col-sm-5 control-label text-right" style="margin-top: 4px">Cơ quan đăng ký:</label>
							<div class="col-sm-7">
								...
								<div>
									<div class="col-md-12" style="margin-bottom: 10px">
										<c:forEach items="${listCount}" var="item">
											<label class="col-md-2" style="font-size: 14px">${item.status} : <b>${item.count}</b></label>
										</c:forEach>
									</div>
								</div>
								</c:if>
								  ...
								  <thead>
								    <tr>
								      ...
								      <th class="th-sm" style="width : 150px;">Họ và tên
								      </th>
								      <th class="th-sm" style="width : 100px;">Ngày sinh
								      </th>
								      <th class="th-sm" style="width : 100px;">Giới tính
								      </th>
								      <th class="th-sm" style="width : 100px;">Số CMND/CCCD
								      </th>
								      <th class="th-sm" style="width : 200px;">Trạng thái hồ sơ
								      </th>
	  ...
	  <div class="modal-dialog modal-dialog-centered" role="document" style="width: 1400px;">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title" id="exampleModalLongTitle" style="display: inline-block;">IN BÁO CÁO TIẾN TRÌNH ĐĂNG KÝ</h5>
