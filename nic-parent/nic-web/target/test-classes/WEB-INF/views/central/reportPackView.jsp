...
<script type="text/javascript">   
    function searchTran() {
    	if(($('#fromDate').val() == null || $('#fromDate').val() == '') && ($('#toDate').val() == null || $('#toDate').val() == '') && ($('#regSiteCode').val() == null || $('#regSiteCode').val() == '') && ($('#printSiteCode').val() == null || $('#printSiteCode').val() == '')){
...
<div class="content-item-title">
            <div class="oplog-title__txt">Báo cáo tiến trình đóng gói</div>
        </div>
