...
<c:url var="backBtnUrl" value="/servlet/investigationBoss/investigationPendingBossList" />
<c:url var="homeUrl" value="/servlet/user/home" />	
<c:url var="apiUrl" value="/servlet/investigation/apiCheck" />		
<!-- TRUNG THÊM THÔNG TIN -->
<c:url var="txnDetailInitUrl" value="/servlet/investigationBoss/txnDetailTrans" />
<!-- END -->
...
<style>
   ...
   <div class="new-heading-2">CHI TIẾT GIAO DỊCH CHỜ LÃNH ĐẠO PHÊ DUYỆT</div>
    ...
    <div class="data_table2" style="margin:30px 0px; color: #337ab7;">
		...
		<div class="waitingWhenDoneWaiting" style="display:block; position: fixed; bottom:5px; right:10px; border-radius: 5px; border: 1px solid gray; background-color: rgb(255, 255, 255); z-index: +1000">
			<div style="margin: 10px"> 
				<button type="button" class="btn btn-primary" onclick="requestToConfirmBCA(); return false;" name="approve">
		...
		<c:url var="rejectUrl_noHit" value="/servlet/investigationBoss/reject_noHitP" />
		<c:url var="approveUrl_noHit" value="/servlet/investigationBoss/approve_conf_boss" />
		
		<div id="dialog-reject-getRemarks" title="Từ chối hồ sơ" style="display: none;"> 
		...
		function openBoxReject(){
		  ...
		  function doReject() { 
		   ...
		   function doReject_noHit() {
				...
				investigationHitData.action = "${rejectUrl_noHit}/" + id; 
			  	document.forms["investigationHitData"].submit();  
		   }
