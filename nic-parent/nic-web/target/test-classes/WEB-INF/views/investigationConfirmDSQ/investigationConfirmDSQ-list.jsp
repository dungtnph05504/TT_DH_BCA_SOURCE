	...
	<div class="form-desing">
		<div>
			<div>
				<div class="row">
					<div class="ov_hidden">
						<div class="new-heading-2">DANH SÁCH KIỂM DUYỆT HỒ SƠ(TỪ CƠ QUAN ĐẠI DIỆN)</div>
								...
								<div class="col-md-4 col-sm-4">
									...
									<div class="col-md-7 col-sm-7 cls-mg-bot">
										<form:select path="validateInfoBca" style="width: 100%;">
											...
											<form:option value="3">Đã xác nhận</form:option>
										</form:select>
									</div>
									<div class="col-md-12">
							...
							<div>
								  ...
								  <thead>
								    <tr>
								      ...
								      <th class="th-sm" style="min-width: 120px;">Ngày trả
								
								      </th>
								      <th class="th-sm" style="min-width: 100px;">Ưu tiên
								
								      </th>
								      <th class="th-sm" style="min-width: 100px;">Nơi đăng ký
								      ...
								      <th class="th-sm" style="max-width: 120px;">Tình trạng
								      </th>
								  ...
								  <tbody>
								    <c:forEach items="${jobList}" var="item">
									    <tr>
									      <td><c:url var="jobUrl" value="/servlet/investigationConfirmDSQ/startDetailInvestigation/${item.uploadJobId}" />
					...
					<br />
						...
						<c:if test="${not empty jobList}">
							<display:table cellspacing="1" cellpadding="0" id="row"
								...
								requestURI="/servlet/investigationConfirmDSQ/investigationConfirmDSQList">
								...
								<display:column title="ID" sortProperty="uploadJobId"
									sortable="false">
									<c:url var="jobUrl" value="/servlet/investigationConfirmDSQ/startDetailInvestigation/${row.uploadJobId}" />
								...
								<display:column property="validateInfoBca_des"
									sortable="false" title="Tình trạng xác minh" maxLength="64" />	
...
//$('.dataTables_length').addClass('bs-select');
	...
	window.pagObj = $('#pagination').twbsPagination({
			...
			onPageClick: function (event, page) {
				if (currentPage != page) {
					$('#pageNo').val(page);
					document.forms["formData"].action = '${JobInvestigationConfirmDSQUrl}';  
	...
	function doApplyFilter() {
		document.forms["formData"].action = '<c:url value="/servlet/investigationConfirmDSQ/applyFilter" />';
		document.forms["formData"].submit();
	}
