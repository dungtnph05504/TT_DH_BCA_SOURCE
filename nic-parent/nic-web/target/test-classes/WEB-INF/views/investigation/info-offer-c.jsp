...
<div class="cls-div" id="theDeXuatC">
    <div style=" border: 0px solid #999; margin:0 auto; position:relative">
            ...
            <table class="tableReportLDS" cellpadding="20" cellspacing="0" border="0" style="width:100%">
                <tbody><tr>
                    <td style="width:35%; text-align:center">
                        ...
                        <p style="padding:0; margin:0 auto; position:relative; top:10px;"> Số: ....... / TB-BTHS(P5) </p>
                    </td>
                ...
                <tr>
                    <td colspan="2" style="width:100%; text-align:center;margin:0 auto">
                        ...
                        <span>
                            Công dân Việt Nam cần bổ túc thêm hồ sơ.
                        </span>
                    </td>
                </tr>
            </tbody></table>
                ...
                <tr>
                    ...
                    <td valign="top" style="border-bottom:1px solid #000;padding-bottom:7px;">
                        ...
                        <table cellpadding="0" cellspacing="0" style="line-height:2;width:100%;">
                            <tbody><tr>
                                <td style="width:60%;" >1. Họ và tên:  ${entity.hoTen} </td>
                                <td style="width:40%;" >2. Giới tính: ${entity.gioiTinh}</td>
                            </tr>
                            <tr>
                                <td style="width:60%;" >3. Ngày sinh: ${entity.ngaySinh}</td>
                                <td style="width:40%;" >4. Nơi sinh: ${entity.noiSinh}</td>
                            </tr>
                            <tr>
                                <td colspan="2" >5. Số CMND/CCCD: ${entity.soCMND}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="2">
                                    <div style="white-space: normal;">7. Cần bổ túc: <p style="white-space:pre-line;" >${entity.noiDungDeXuat}</p></div>
                                     <br>
                                </td>
                            </tr>
                        </tbody></table>
            ...
            <table class="tableReportLDS" cellpadding="20" cellspacing="0" border="0" style="width:100%">
                <tbody><tr>
                    ...
                    <td style="width:60%; text-align:center; padding-top:20px">
                        <p style="padding:0; margin:0 auto; letter-spacing:2px"><b> ${entityOffer.chucVu} </b></p><br>
                        <p style="padding-top:50px; font-family:&#39;Times New Roman&#39;, Arial; font-size:12pt;">  ${entityOffer.lanhDao}</p>
...
function inDeXuatC(){
    ...
    mywindow.document.write(document.getElementById("theDeXuatC").innerHTML);
