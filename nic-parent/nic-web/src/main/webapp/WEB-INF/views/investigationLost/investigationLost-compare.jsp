...
<c:url var="backBtnUrl" value="/servlet/investigationLost/investigationLostList" />
...
<c:url var="txnDetailInitUrl" value="/servlet/investigationLost/txnDetailTrans" />
<!-- END -->			
...
<style>
   ...
   <div class="new-heading-2">CHI TIẾT HỒ SƠ BÁO MẤT</div>
...
<%--         <div class="form-group text">
        ...
        <div class="form-group text">
            <label class="control-label" style="width: 35%;color: #000;">Số điện thoại</label>
            <label class="control-label">:</label>
            <c:out value="${nicData.nicRegistrationData.contactNo}" />
             <%-- <c:choose>
        ...
        <div class="form-group text">
            <label class="control-label" style="width: 35%;color: #000;">Ngày cấp Hộ chiếu</label>
            <label class="control-label">:</label>
            <c:out value="${nicData.datePassportDesc}" />
        </div>
        <div class="form-group text">
            <label class="control-label" style="width: 35%;color: #000;">Nơi cấp</label>
            <label class="control-label">:</label>
            <c:out value="${nicData.nicRegistrationData.nameProvider}" />
        </div>
    </div>
    
    <div class="data_table2" style="margin:30px 0px; color: #337ab7;">
        <div class="form-group text">
            <label class="control-label" style="width: 35%;color: #000;">Mục đích</label>
            <label class="control-label">:</label>
            <c:out value="${nicData.nicRegistrationData.purposeKind}" />
        </div>
        <div class="form-group text">
            <label class="control-label" style="width: 35%;color: #000;">Lý do mất</label>
            <label class="control-label">:</label>
            <c:out value="${nicData.nicRegistrationData.reasonKind}" />
        </div>
        <div class="form-group text">
            <label class="control-label" style="width: 35%;color: #000;">Đến nước sở tại ngày</label>
            <label class="control-label">:</label>
             <c:out value="${nicData.dateCountryDesc}" />
            <%-- <c:choose>
        ...
        <div class="form-group text">
            <label class="control-label" style="width: 35%;color: #000;">Số hộ chiếu</label>
            <label class="control-label">:</label>
            <c:choose>
        ...
        <div class="form-group text">
            <label class="control-label" style="width: 35%;color: #000;">Địa chỉ hiện tại</label>
            <label class="control-label">:</label>
            <c:out value="${nicData.nicRegistrationData.overseasCountry}" />
        </div>
        <div class="form-group text">
...
<%--         <div class="form-group text">
        ...
        <div class="form-group text">
            <label class="control-label" style="width: 35%;color: #000;">Ngày cấp Hộ chiếu</label>
            <label class="control-label">:</label>
            <c:out value="${nicData.nicRegistrationData.datePassport}" />
        </div>
        <div class="form-group text">
            <label class="control-label" style="width: 35%;color: #000;">Nơi cấp</label>
            <label class="control-label">:</label>
         ...
         <div class="form-group text">
            <label class="control-label" style="width: 35%;color: #000;">Chức vụ</label>
            <label class="control-label">:</label>
            <c:out value="${nicData.nicRegistrationData.position}" />
        </div>
    </div>
    ...
    <div id="dialog-approve"></div>
		...
		<div class="waitingWhenDoneWaiting" style="display:block; position: fixed; bottom:5px; right:10px; border-radius: 5px; border: 1px solid gray; background-color: rgb(255, 255, 255); z-index: +1000">
			<div style="margin: 10px"> 
				<!-- <input type="button" class="btn btn-primary"              onclick="requestApprove();" name="approve"  value="Phê duyệt" /> 
				&nbsp; 
				<input type="button" class="btn btn-primary"              onclick="requestToPendingBCA();" name="pendingBCa"  value="Yêu cầu xác minh" /> 
				&nbsp; 
				<input type="button" class="btn btn-primary"              onclick="openBoxReject();" name="reject"  value="Từ chối" /> 
				&nbsp;
	...
	<%  /* ******************************************************************************************************************** */ %>	
		...
		<c:url var="rejectUrl_noHit" value="/servlet/investigationConfirm/reject_noHit" />
		<c:url var="approveUrl_noHit" value="/servlet/investigationConfirm/approve_noHit" />
		<c:url var="pending_bca" value="/servlet/investigationConfirm/pending_bca" />
