			...
			<div>
				<div class="row">
					<div class="ov_hidden"> 
						...
						<div class="new-heading-2 col-md-4">DANH SÁCH GỬI BCA</div>
							...
							<div>
								  ...
								  <tbody>
								    <c:forEach items="${jobList}" var="item">
									    <tr>
									      <td><c:url var="jobUrl" value="/servlet/investigationBca/investigationLoadBcaDetail/${item.listCode}" />
					...
					<br />
						...
						<c:if test="${not empty jobList}">
							<display:table cellspacing="1" cellpadding="0" id="row"
								...
								requestURI="/servlet/investigationBca/investigationLoadBcaList">
								...
								<display:column title="Mã danh sách" sortProperty="listCode"
									sortable="false">
									<c:url var="jobUrl" value="/servlet/investigationBca/investigationLoadBcaDetail/${row.listCode}" />
...
<script type="text/javascript">
	...
	window.pagObj = $('#pagination').twbsPagination({
				...
				onPageClick: function (event, page) {
					if (currentPage != page) {
						$('#pageNo').val(page);
						document.forms["formData"].action = '${JobInvestigationLoadBcaUrl}';  
	...
	function doApplyFilter() {
		document.forms["formData"].action = '<c:url value="/servlet/investigationBca/applyFilterLoading" />';
		document.forms["formData"].submit();
	}
