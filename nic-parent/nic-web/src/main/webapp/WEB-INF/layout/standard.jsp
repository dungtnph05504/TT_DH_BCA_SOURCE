...
<meta http-equiv="Expires" content="0" />
 ...
 <title>Hộ chiếu điện tử Việt Nam</title>
...
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/editor.css"/>"></link>
...
<link href="<c:url value="/resources/css/treeview/tree.css"/>" rel="stylesheet">
<script src="<c:url value="/resources/js/treeview/tree.js"/>" type="text/javascript"></script>
<script src="<c:url value="/resources/js/treeview/treeitem.js"/>" type="text/javascript"></script>
<script src="<c:url value="/resources/js/treeview/treeitemClick.js"/>" type="text/javascript"></script>
<%-- <link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/datatables.min.css"/>"></link>
<script type=text/javascript src="<c:url value="/resources/js/datatables.min.js" />"></script>   
<script type=text/javascript src="<c:url value="/resources/js/jquery.twbsPagination.js" />"></script> 
<script type="text/javascript" src="<c:url value="/resources/js/notify.js"/>"></script>
