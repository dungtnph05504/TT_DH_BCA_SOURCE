...
<link rel="stylesheet" type="text/css"
	...
	<link rel="stylesheet" type="text/css"
	href="<c:url value="/resources/css/tutorsty.css"/>"></link>
	<link rel="stylesheet" type="text/css"
	href="<c:url value="/resources/css/flexcrollstyles.css"/>"></link>
			...
			<div class=shadow3>
				...
				<!--<div class=container style="background-color: #DDDDDD;">
					--><tiles:insertTemplate template="/WEB-INF/layout/header.jsp" />
					   <tiles:insertTemplate template="/WEB-INF/layout/nic-menu.jsp" />
