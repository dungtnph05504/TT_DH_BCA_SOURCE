...
"transactionType", "transactionStatus", "checksum", "isPostOffice", "recieptNo", "registrationNo", "passportStyle", 
"regisData", "families", "documents", "prevPassportNo", "placeIssuance", "prevDateOfIssue", "idQueue",
"prevDateOfExpr", "appointmentPlace", "applicant", "registrationType", "paBlacklistId", "paInqBllUser", 
"paArchiveCode", "paSearchBio", "description","paJoinPersonDate", "paSearchObjDate", "paSaveDocDate", "note", "passportInfo", "person"})
public class Transaction {
	...
	private PassportCancelDetail passportInfo;
	...
	public PassportCancelDetail getPassportInfo() {
		return passportInfo;
	}
	public void setPassportInfo(PassportCancelDetail passportInfo) {
