...
@XmlType ( name = "PassportInfo",  propOrder = { "transactionId","fullName", "pid", "dob", "gender", "address", 
		...
		"stylePassport", "receiptNo", "epp_persons", "detailaddress", "estOfRecieve", "namePlaceOfIssue", "handoverA", "prevPassport", "regSiteCode", "docType"} )
public class PassportInfo {
	...
	public PrevPassport getPrevPassport() {
		return prevPassport;
	}

	public void setPrevPassport(PrevPassport prevPassport) {
	...
	public String getEstOfRecieve() {
		return estOfRecieve;
	}

	public void setEstOfRecieve(String estOfRecieve) {
