...
public class FunctionsJson implements java.io.Serializable {
	...
	public FunctionsJson() {
	}

	public FunctionsJson(String functionId) {
		this.functionId = functionId;
	}

	public FunctionsJson(String functionId, String functionDesc,
			String functionCategory, String functionUrl, String systemId,
	...
	public String toString() {
		return "Functions [functionId=" + functionId + ", functionDesc="
				+ functionDesc + ", functionCategory=" + functionCategory
				+ ", functionUrl=" + functionUrl + ", systemId=" + systemId
				+ ", createBy=" + createBy + ", createWkstnId=" + createWkstnId
