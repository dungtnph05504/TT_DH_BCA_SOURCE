...
public interface NicTransactionDao extends GenericDao<NicTransaction, String> {
	...
	public PaginatedResult<NicTransaction> getPageByRegDateOrRegSite(
			Date fDate, Date tDate, String regSiteCode, int pageNo, int pageSite) throws Exception;

	public List<NicTransaction> findByCoditions(
			Date fDate, Date tDate, String regSiteCode)throws Exception;
	...
	public List<ReportRegProcessData> getAllByCodition(String fromDate,
			String toDate, String regSiteCode, String printSiteCode) throws Exception;
