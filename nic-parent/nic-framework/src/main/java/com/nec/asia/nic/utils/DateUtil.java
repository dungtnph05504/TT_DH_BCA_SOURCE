 ...
 * <br>
 * Tutorial: <br>
 * String dtStr = DateUtil.parseDate(new java.util.Date(),FORMAT_DD_MM_YYYY);
 * <p>
 ...
 *  
 * 09 Aug 2013 (chris): add format dd-MM-yyyy for Data Governance Standard Date Format. 
 * 26 Feb 2016 (tue): add format MM/dd/yyyy for Schedule Duration Date Format.
 * 30 May 2017 (chris): add format yyMMdd
 */
public class DateUtil {
	...
	/** The Constant FORMAT_YYYYMMDDHHMMSSSSS. */
	public static final String FORMAT_YYYYMMDDHHMMSSSSS = "yyyyMMddHHmmssSSS";
	
	/** The Constant FORMAT_YYMMDD. */
	...
	/** The Constant FORMAT_DD MMM YYYY. */
	 public static final String FORMAT_DDdashMMMdashYYYY = "dd-MMM-yyyy";
	    ...
	    /** The Constant FORMAT_YYYY-MM-DD. */
     public static final String FORMAT_YYYYdashMMdashDD = "yyyy-MM-dd";
     
	public static final String FORMAT_DDdashMMMdashYYYY_HH24_MM = "dd-MMM-yyyy HH:mm";
	
	public static final String FORMAT_DDdashMMMMdashYYYY_HH24_MM = "dd-MMMM-yyyy HH:mm";
	
	/** ADDED:  JESUS:  2016 01 25:  FORMAT:  "October 5, 1971" */
	public static final String FORMAT__MONTH_FULL_TEXT__DAY__YEAR_FULL = "MMMMM dd, yyyy";
	
	/** The Constant FORMAT_MM_DD_YYYY. */
	public static final String FORMAT_MM_DD_YYYY = "MM/dd/yyyy";
	
	/** The Constant FORMAT_MM_DD_YYYY_HH_MM_SS. */
	public static final String FORMAT_MM_DD_YYYY_HH_MM_SS = "MM/dd/yyyy HH:mm:ss";
    
	public static final String FORMAT_DDdashMMMdashYYYY_HH24_MM_SS = "dd-MMM-yyyy HH:mm:ss";
	
	public static final String FORMAT_DDdashMMdashYYYY_HH24_MM_SS = "dd-MM-yyyy HH:mm:ss";
    ...
    */
	...
	public static Date getDateWithoutTimestime(Date date) {
	       Calendar calendar = Calendar.getInstance();
	        calendar.setTime(date);
    ...
    /**
     * Description: This method format java.util.Date by specified string format
     * 
     * @param date
     * @param format
     * @return date
