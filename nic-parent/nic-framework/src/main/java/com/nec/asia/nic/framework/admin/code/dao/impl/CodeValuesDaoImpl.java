...
public class CodeValuesDaoImpl extends
	...
	public PaginatedResult<CodeValues> getCodevalueByCoditions(String codeId,
		...
		if (StringUtils.isNotBlank(codeValueDesc)) {
			criteria.add(Restrictions.eq("codeValueDesc", codeValueDesc));
		}
		pegCodeValueList = this.findAllForPagination(criteria, pageNo, pageSize, Order.asc("codePriority"));
